# Generated by Django 3.1 on 2021-06-24 16:06

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import django.utils.timezone
import questionnaire.models.survey
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expire_date', models.DateField(blank=True, default=questionnaire.models.survey.in_duration_day, verbose_name='Expiration date')),
            ],
            options={
                'verbose_name': 'survey',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='questionnaire.survey', verbose_name='Survey')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='questionnaire.category', verbose_name='Category')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='questionnaire.survey', verbose_name='Survey')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='category',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='questionnaire.survey', verbose_name='Survey'),
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('response', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='questionnaire.response', verbose_name='Response')),
            ],
        ),
    ]
