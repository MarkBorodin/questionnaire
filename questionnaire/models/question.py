...
class Question(models.Model):
    ...
    survey = models.ForeignKey(Survey, on_delete=models.CASCADE, verbose_name=_("Survey"), related_name="questions", null=True, blank=True)
    survey_template = models.ForeignKey(SurveyTemplate, on_delete=models.CASCADE, verbose_name=_("SurveyTemplate"), related_name="questions", null=True, blank=True)
